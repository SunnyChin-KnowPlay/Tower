...
{
	public partial class ReqQuitFromCenterServer : Protocol<ReqQuitFromCenterServer>
	{
		public delegate bool ReceivedHandle(ReqQuitFromCenterServer protocol);
		...
		private static uint16 s_ProtocolType = 0x0F04;
		
		public ReqQuitFromCenterServer()
		{

		}

		public ReqQuitFromCenterServer(AgentBase agent = null) : base(agent)
		{
        ...
        {
            return "ReqQuitFromCenterServer";
        }

		private static ReqQuitFromCenterServer s_ReqQuitFromCenterServer;
		public static ReqQuitFromCenterServer Instance
		{
			get
			{
				if (s_ReqQuitFromCenterServer == null)
				{
					s_ReqQuitFromCenterServer = new ReqQuitFromCenterServer();
				}
				return s_ReqQuitFromCenterServer;
			}
		}
		...
		public ReqQuitFromCenterServer Clone()
		{
			ReqQuitFromCenterServer obj = new ReqQuitFromCenterServer();
			obj.Server = this.Server.Clone();
			return obj;
		}

		public static ReqQuitFromCenterServer operator +(ReqQuitFromCenterServer s1, ReceivedHandle handle)
        {
		...
		public static ReqQuitFromCenterServer operator -(ReqQuitFromCenterServer s1, object target)
        {
		...
		public override void Dispatch(IProtocol t)
		{
			...
			foreach (ReceivedPkg pkg in m_Receiveds)
			{
				isContinue = pkg.m_Handle.Invoke(t as ReqQuitFromCenterServer);
		...
		{
			return new ReqQuitFromCenterServer(m_Agent);
		}
